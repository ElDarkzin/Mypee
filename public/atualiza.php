...
<head>
    ...
    <title>Atualizar Banheiro</title>
</head>
<body>
  ...
  <div class="main-login">
        ...
        <h1><br>Atualize seu banheiro</h1>
            <img src="../public/assets/media/atualizar.svg" class="left-login-image" alt="">
        </div>
        
        <div class="right-login">
          <div class="card-login">
            <h1>Atualizar banheiro</h1>
            <div class="textfield">
                <label for="local">Local Banheiro</label>
                <input id="local" type="text" name="local_banheiro" placeholder="Localização do banheiro" required>
            </div>
            <div class="textfield">
          ...
          <a><button class="btn-register" type="submit">Editar Banheiro</button></a>
          <a><button class="btn-register" type="reset">Reiniciar</button></a>
          </form>
          </div>
          </div>
      </body>
